...
public class Settings {
    ...
    private int preLoginRateLimitAttempts = 10;
    private int preLoginRateLimitMinutes = 1;
    private boolean blockCommandsBeforeAuth = false;
    // Debug settings
    ...
    private void applyLoadedState(SettingsLoader.LoadedState state) {
        ...
        preLoginRateLimitAttempts = state.preLoginRateLimitAttempts;
        preLoginRateLimitMinutes = state.preLoginRateLimitMinutes;
        blockCommandsBeforeAuth = state.blockCommandsBeforeAuth;
