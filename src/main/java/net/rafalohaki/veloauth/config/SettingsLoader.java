...
final class SettingsLoader {
    ...
    private static void loadSecuritySettings(Map<String, Object> config, LoadedState state) {
        ...
        // New security settings (v1.0.4+)
        state.maxConcurrentSessions = YamlParserUtils.getInt(security,
            "max-concurrent-sessions", state.maxConcurrentSessions);
        state.preLoginRateLimitAttempts = YamlParserUtils.getInt(security,
            "prelogin-ratelimit-attempts", state.preLoginRateLimitAttempts);
        state.preLoginRateLimitMinutes = YamlParserUtils.getInt(security,
            "prelogin-ratelimit-minutes", state.preLoginRateLimitMinutes);
        state.blockCommandsBeforeAuth = YamlParserUtils.getBoolean(security,
            "block-commands-before-auth", state.blockCommandsBeforeAuth);
    }
    ...
    static final class LoadedState {
        ...
        int preLoginRateLimitAttempts;
        int preLoginRateLimitMinutes;
        boolean blockCommandsBeforeAuth;
        ...
        static LoadedState from(Settings settings) {
            ...
            // New security settings (v1.0.4+)
            state.maxConcurrentSessions = settings.getMaxConcurrentSessions();
            state.preLoginRateLimitAttempts = settings.getPreLoginRateLimitAttempts();
            state.preLoginRateLimitMinutes = settings.getPreLoginRateLimitMinutes();
            state.blockCommandsBeforeAuth = settings.isBlockCommandsBeforeAuth();
